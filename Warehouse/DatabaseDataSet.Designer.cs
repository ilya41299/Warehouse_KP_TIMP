...
namespace Warehouse {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class ArticlesDataTable : global::System.Data.TypedTableBase<ArticlesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ArticlesRow AddArticlesRow(int Id, string Name, string Manufacturer) {
        ...
        public partial class ArticlesRow : global::System.Data.DataRow {
            ...
            public string Manufacturer {
                get {
                    return ((string)(this[this.tableArticles.ManufacturerColumn]));
                }
                set {
                    this[this.tableArticles.ManufacturerColumn] = value;
                }
            }
        }
...
namespace Warehouse.DatabaseDataSetTableAdapters {
    ...
    public partial class ArticlesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Articles] WHERE (([Id] = @Original_Id) AND ([Name] = @Original" +
                "_Name) AND ([Manufacturer] = @Original_Manufacturer))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Articles] ([Id], [Name], [Manufacturer]) VALUES (@Id, @Name, @" +
                "Manufacturer);\r\nSELECT Id, Name, Manufacturer FROM Articles WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Articles] SET [Id] = @Id, [Name] = @Name, [Manufacturer] = @Manufac" +
                "turer WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Manufactu" +
                "rer] = @Original_Manufacturer));\r\nSELECT Id, Name, Manufacturer FROM Articles WH" +
                "ERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Warehouse.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Manufacturer FROM dbo.Articles";
        ...
        public virtual int Fill(DatabaseDataSet.ArticlesDataTable dataTable) {
        ...
        public virtual DatabaseDataSet.ArticlesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet.ArticlesDataTable dataTable = new DatabaseDataSet.ArticlesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet.ArticlesDataTable dataTable) {
        ...
        public virtual int Update(int Id, string Name, string Manufacturer, int Original_Id, string Original_Name, string Original_Manufacturer) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Manufacturer, int Original_Id, string Original_Name, string Original_Manufacturer) {
            return this.Update(Original_Id, Name, Manufacturer, Original_Id, Original_Name, Original_Manufacturer);
        }
    }
